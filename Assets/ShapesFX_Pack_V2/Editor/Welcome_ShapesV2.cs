...
namespace Orangedkeys.ShapesFX_V2
{
    public class Welcome_ShapesV2 : EditorWindow
    {
        ...
        [MenuItem("Tools/OrangedKeys/ShapesFX_Pack_Vol2/About ", false, 0)]
        public static void ShowWindow()
        {
            EditorWindow editorWindow = GetWindow(typeof(Welcome_ShapesV2), false, " About ", true);
        ...
        private void OnGUI()
        {
            ...
            */
            ...
            // Add The Banner
            Texture2D welcomeImage = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/ShapesFX_Pack_V2/Resources/Gui_ShapesFX_PACK_v2.png", typeof(Texture2D));
            ...
            EditorGUILayout.LabelField("Have fun with ''SHAPES FX PACK VOL2'' !! \n", LargeTextStyle);
            EditorGUILayout.Space();
            EditorGUILayout.LabelField("Subscribe to OrangedKeys Newsletter to be THE FIRST to hear about our Next Assets Releases/Updates. \n", RegularTextStyle);
            EditorGUILayout.Space();
            ...
            EditorGUILayout.LabelField("Copyright © 2021 OrangedKeys", FooterTextStyle);
            GUILayout.EndArea();
